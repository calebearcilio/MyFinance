...
class $CategoriesTable extends Categories
  ...
  static TypeConverter<IconData, int> $convertericon = const IconConverter();
...
class CategoryData extends DataClass implements Insertable<CategoryData> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, name, icon, color, type, isDefault, createdAt, updatedAt);
  @override
...
class $$CategoriesTableFilterComposer
  ...
  ColumnWithTypeConverterFilters<IconData, IconData, int> get icon =>
      $composableBuilder(
        column: $table.icon,
...
class $$CategoriesTableAnnotationComposer
  ...
  GeneratedColumnWithTypeConverter<IconData, int> get icon =>
